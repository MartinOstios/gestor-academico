              ...
              <ng-container matColumnDef="acciones">
                ...
                <td mat-cell *matCellDef="let row">
                  <div class="action-buttons">
                    <button mat-mini-fab color="primary" (click)="editarEstudiante(row.id)" matTooltip="Editar estudiante">
                    ...
                    <button mat-mini-fab color="warn" (click)="eliminarEstudiante(row.id)" matTooltip="Eliminar estudiante">
...
export class EstudianteListComponent implements OnInit {
  ...
  verCalificaciones(id: string): void {
    this.router.navigate([`/calificaciones/estudiante/${id}`]);
  }
} 